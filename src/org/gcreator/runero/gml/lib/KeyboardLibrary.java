...
public abstract class KeyboardLibrary {

    public static void clearKeyCache() {
        keyboardDownKeys.clear();
    }

    public static LinkedList<Integer> keyboardDownKeys = new LinkedList<Integer>();
    ...
    public static int[] getCodes(int awtKey) {
        int type = getLWJGLKey(awtKey);
